...
export const statusCommand = new Command('status')
  ...
  .action(async () => {
    console.log(chalk.cyan('📊 n00plicate Design Token Pipeline Status\n'));
    ...
    console.log('  • n00plicate-tokens init    - Setup configuration');
    console.log('  • n00plicate-tokens export  - Export from Penpot');
    console.log('  • n00plicate-tokens build   - Generate outputs');
    console.log('  • n00plicate-tokens sync    - Export + build');
    console.log('  • n00plicate-tokens watch   - Watch for changes');
  });
